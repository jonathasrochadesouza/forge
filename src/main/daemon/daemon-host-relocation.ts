...
// Why 'Forge': must not match the installed upstream Orca's root, or this build's installer/uninstaller would sweep Orca's daemon-host.
const LOCAL_HOST_ROOT_NAME = 'Forge'
