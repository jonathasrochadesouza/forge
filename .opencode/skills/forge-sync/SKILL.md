---
name: forge-sync
description: Use when the user asks to sync, update, or pull changes from upstream (stablyai/orca) into the forge fork, or when a merge from upstream/main is needed. Triggers on words like "sync", "atualizar do upstream", "pull da upstream", "pegar as novidades do orca".
---
